...
values ('After Hours', '2020-01-01'),
	('1989', '2014-01-01'),
	('Un Verano Sin Ti', '2022-01-01'),
	('Views', '2016-01-01');

insert into song (name, duration, album_id)
values ('Me Porto Bonito', '00:02:59', 3),
	('Look What You Made Me Do', '00:03:35', 2),
	('One Dance', '00:02:24', 4),
	('Blinding Lights', '00:04:30', 1),
	('Hotline Bling', '00:03:40', 4),
	('Blank Space', '00:04:23', 2);

insert into compilation (name, release_year)
values ('best rap', '2020-01-01'),
	('best pop', '2019-01-01'),
	('new hits', '2023-01-01'),
...
values (1,1), (2,2), (3,4), (4,4), (1,3);

insert into song_compilation (song_id, compilation_id)
values (1,1), (1,3), (2,2), (3,2), (4,3), (5,1), (6,2), (6,4)
